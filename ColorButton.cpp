...
void AFXAPI DDX_ColorButtonX(CDataExchange *pDX, int nIDC, COLORREF& crColour)
{
    HWND hWndCtrl = pDX->PrepareCtrl(nIDC);
    ASSERT (hWndCtrl != NULL);                
    
    CColorButtonX* pColourButton = (CColorButtonX*) CWnd::FromHandle(hWndCtrl);
...
//**                            MFC Macros                            **
//***********************************************************************
IMPLEMENT_DYNCREATE(CColorButtonX, CButton)

//***********************************************************************
// Method:	CColorButton::CColorButton(void)
// Notes:	Default Constructor.
//***********************************************************************
CColorButtonX::CColorButtonX(void):	
	_Inherited(),
	m_Color(CLR_DEFAULT),
...
// Notes:	None.
//***********************************************************************
COLORREF CColorButtonX::GetColor(void) const
{
	return m_Color;
}
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::SetColor(COLORREF Color)
{
	m_Color = Color;
...
// Notes:	None.
//***********************************************************************
COLORREF CColorButtonX::GetDefaultColor(void) const
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::SetDefaultColor(COLORREF Color)
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::SetCustomText(LPCTSTR tszText)
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::SetDefaultText(LPCTSTR tszText)
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::SetTrackSelection(BOOL bTrack)
{
...
// Notes:	None.
//***********************************************************************
BOOL CColorButtonX::GetTrackSelection(void) const
{
...
//**                         CButton Overrides                         **
//***********************************************************************
void CColorButtonX::PreSubclassWindow() 
{
...
//**                         Message Handlers                         **
//***********************************************************************
BEGIN_MESSAGE_MAP(CColorButtonX, CButton)
    //{{AFX_MSG_MAP(CColorButtonX)
...
// Notes:	None.
//***********************************************************************
LONG CColorButtonX::OnSelEndOK(UINT lParam, LONG /*wParam*/)
{
	m_bPopupActive = FALSE;
...
// Notes:	None.
//***********************************************************************
LONG CColorButtonX::OnSelEndCancel(UINT lParam, LONG /*wParam*/)
{
	m_bPopupActive = FALSE;
...
// Notes:	None.
//***********************************************************************
LONG CColorButtonX::OnSelChange(UINT lParam, LONG /*wParam*/)
{
...
//***********************************************************************
// Method:	CColorButtonX::OnCreate()
// Notes:	None.
//***********************************************************************
int CColorButtonX::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
// Notes:	None.
//***********************************************************************
void CColorButtonX::DrawArrow(CDC* pDC, 
							 RECT* pRect, 
							 int iDirection,
